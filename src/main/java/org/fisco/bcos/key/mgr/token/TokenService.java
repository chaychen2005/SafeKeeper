 ...
 */
package org.fisco.bcos.key.mgr.token;

import org.fisco.bcos.key.mgr.base.code.ConstantCode;
import org.fisco.bcos.key.mgr.base.enums.TokenType;
...
public class TokenService {
    ...
    public String createToken(String value, int type) {
        ...
        String token = KeyMgrTools.shaEncode(UUID.randomUUID() + value);
        //save token
    ...
    public String getValueFromToken(String token) {
        ...
        if (Objects.isNull(tbToken)) {
            ...
            throw new KeyMgrException(ConstantCode.INVALID_TOKEN);
        }
        ...
        if (now.isAfter(tbToken.getExpireTime())) {
            ...
            throw new KeyMgrException(ConstantCode.TOKEN_EXPIRE);
        }

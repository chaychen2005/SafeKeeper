...
public class ConstantCode {
    ...
    public static final RetCode EMPTY_ACCOUNT_NAME = RetCode.mark(200102, "account name cannot be empty");

    public static final RetCode PASSWORD_ERROR = RetCode.mark(200103, "password error");

    public static final RetCode REUSED_PASSWORD = RetCode.mark(200104, "the new password cannot be same as old");
    ...
    public static final RetCode INVALID_ACCOUNT_FORMAT = RetCode.mark(200107, "invalid account format. account should begin with a letter, between 5 and 20 in length, and contain only characters, numbers, and underscores");

    public static final RetCode INVALID_PASSWORD_FORMAT = RetCode.mark(200108, "invalid password format. password should be between 6 and 20 in length, and contain only characters, numbers, and underscores");

    public static final RetCode ACCOUNT_ACCESS_DENIAL = RetCode.mark(200109, "lack of access to the account");

    public static final RetCode INVALID_PUBLIC_KEY_LENGTH = RetCode.mark(200110, "invalid public key length");
    ...
    public static final RetCode EMPTY_DATA_ESCROW_ID = RetCode.mark(200202, "data id cannot be empty");

    public static final RetCode DATA_ESCROW_ACCESS_DENIAL = RetCode.mark(200203, "lack of access to the escrow data");
    ...
    public static final RetCode EMPTY_DATA_ENTITY_ID = RetCode.mark(200401, "data entity id cannot be empty");

    public static final RetCode EMPTY_DATA_FIELD_ID = RetCode.mark(200402, "data field id cannot be empty");
    ...
    public static final RetCode NOT_SUFFICIENT_CREDITS = RetCode.mark(200900, "not sufficient credit");

    /* auth */
    public static final RetCode ACCESS_DENIED = RetCode.mark(300000, "access denied");

    public static final RetCode ADMIN_ROLE_REQUIRED = RetCode.mark(300001, "the operation requires admin privileges");

    public static final RetCode USER_ROLE_REQUIRED = RetCode.mark(300002, "the operation requires user privileges");

...
public class SafeKeeperException extends RuntimeException {
    ...
    /** init by RetCode. */
    public SafeKeeperException(RetCode retCode) {
        super(retCode.getMessage());
        this.retCode = retCode;
    }

    /** init by RetCode and Throwable. */
    public SafeKeeperException(RetCode retCode, Throwable cause) {
    ...
    public SafeKeeperException(int code, String msg) {
        super(msg);
        this.retCode = new RetCode(code, msg);
    }

    /** init by code/msg and Throwable. */
    public SafeKeeperException(int code, String msg, Throwable cause) {
        super(msg, cause);
        this.retCode = new RetCode(code, msg);
    }
